...
import com.lei.recyclerview.utils.ViewUtils;
...
public class RecyclerViewPager extends RecyclerView {
        ...
        if (childCount > 0) {
            ...
            if (targetPosition == curPosition
                ...
                if (centerXChild != null) {
                    ...
                    } else if (mTouchSpan < centerXChild.getWidth() * -mTriggerOffset && targetPosition !=
                            getItemCount() - 1) {
                        if (!reverseLayout) targetPosition++;
                        else targetPosition--;
                    }
        ...
        if (childCount > 0) {
            ...
            if (targetPosition == curPosition
                ...
                if (centerYChild != null) {
                    ...
                    } else if (mTouchSpan < centerYChild.getHeight() * -mTriggerOffset && targetPosition !=
                            getItemCount() - 1) {
                        if (!reverseLayout) targetPosition++;
                        else targetPosition--;
                    }
            ...
            if (mNeedAdjust) {
                ...
                if (mCurView != null) {
                    ...
                    if (getLayoutManager().canScrollHorizontally()) {
                        ...
                        } else if (spanX < mCurView.getWidth() * -mTriggerOffset && mCurView.getLeft() <=
                                mMinLeftWhenDragging) {
                            if (!reverseLayout) targetPosition++;
                            else targetPosition--;
                        }
                    } else {
                        ...
                        } else if (spanY < mCurView.getHeight() * -mTriggerOffset && mCurView.getTop() <=
                                mMinTopWhenDragging) {
                            if (!reverseLayout) targetPosition++;
                            else targetPosition--;
                        }
    ...
    protected RecyclerViewPagerAdapter ensureRecyclerViewPagerAdapter(Adapter adapter) {
        return (adapter instanceof RecyclerViewPagerAdapter)
                ? (RecyclerViewPagerAdapter) adapter : new RecyclerViewPagerAdapter(this, adapter);
    }
